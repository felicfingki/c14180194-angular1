...
export class AppComponent {
  ...
  Masuk() {
    ...
    if(this.count1>=4 || this.count2>=4 || this.count3>=4|| this.count4>=4|| this.count5>=4)
    {
      this.win = "Player1 Win";
    }
    else if(this.counter1>=4 || this.counter2>=4 || this.counter3>=4|| this.counter4>=4|| this.counter5>=4)
    {
